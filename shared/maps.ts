...
export const MAPS: GameMap[] = [
  ...
  },
  {
    ...
    description:
      'Enge Gassen zwischen Containern. Elf Wellen, eine Schwarmwelle und die Brutmutter, die sich beim Sterben teilt.',
    difficulty: 1.45,
    moneyScale: 1.25,
    reward: 400,
    boss: 'brood',
  ...
  },
  {
    ...
    description:
      'Befestigte Stellungen mit langen Feuergassen. Zwölf Wellen und der Feldmarschall, der sich und seine Horde heilt.',
    difficulty: 2,
    moneyScale: 1.5,
    reward: 750,
    boss: 'warlord',
  ...
  },
  {
    ...
    description:
      'Offenes Feld ohne Deckung. Dreizehn Wellen und der Artillerist, dessen Bomben sich mit roten Warnkreisen ankündigen.',
    difficulty: 2.8,
    moneyScale: 1.8,
    reward: 1250,
    boss: 'artillery',
  ...
  },
  {
    ...
    description:
      'Bahnsteige und blockierte Gleise. Vierzehn Wellen und der Sogfürst, der den Trupp zu sich zieht und wieder wegschleudert.',
    difficulty: 3.6,
    moneyScale: 2.15,
    reward: 1900,
    boss: 'vortex',
  ...
  },
  {
    ...
    description:
      'Enge Gänge zwischen Hochöfen. Fünfzehn Wellen und der Schlackenherr, der brennende Lavapfützen hinterlässt.',
    difficulty: 4.4,
    moneyScale: 2.5,
    reward: 2600,
    boss: 'slag',
  ...
  },
  {
    ...
    description:
      'Sechzehn Wellen im Festungsring. Der Zerreißer schlägt mit einer gewaltigen Druckwelle zu — der rote Kreis ist die einzige Warnung.',
    difficulty: 5.2,
    moneyScale: 2.9,
    reward: 3750,
    boss: 'render',
  ...
  },
  {
    ...
    description:
      'Eine bewusst kompakte Grabstadt mit kurzen Fluchtwegen. Siebzehn Wellen, dichter Schwarmdruck und kaum Platz für endlose Turmreihen.',
    difficulty: 6,
    moneyScale: 3.3,
    reward: 5250,
    boss: 'swarmqueen',
    ...
    waves: buildWaves({
      ...
      step: 6,
      minis: ['brute', 'warden', 'stalker', 'mortar'],
      miniWaves: [3, 5, 7, 9, 12, 14, 16],
      swarmWaves: [4, 8, 13, 15],
      roster: LATE_ROSTER,
      seed: 6001,
      rareThreatCopies: 2,
    }),
  ...
  },
  {
    ...
    description:
      'Eine ungewohnt weite, offene Reaktorfläche mit achtzehn Wellen und langen Lauf- und Schusswegen. Der Seuchenfürst zwingt den Trupp trotzdem ständig aus seiner Stellung.',
    difficulty: 6.8,
    moneyScale: 3.7,
    reward: 7250,
    boss: 'plague',
    ...
    waves: buildWaves({
      ...
      step: 6,
      minis: ['brute', 'warden', 'stalker', 'mortar'],
      miniWaves: [3, 5, 7, 9, 11, 13, 15, 17],
      swarmWaves: [4, 8, 12, 16],
      roster: LATE_ROSTER,
      seed: 6801,
      rareThreatCopies: 2,
    }),
  ...
  },
  {
    ...
    description:
      'Die alte Endlinie mit neunzehn Wellen. OMEGA bringt fast jede Fähigkeit der bisherigen Bosse mit — heilen kann es sich als einziges nicht.',
    difficulty: 7.6,
    moneyScale: 4.2,
    reward: 11250,
    boss: 'omega',
    ...
    waves: buildWaves({
      ...
      step: 6,
      minis: ['brute', 'warden', 'stalker', 'mortar'],
      miniWaves: [3, 5, 7, 9, 12, 14, 16, 18],
      swarmWaves: [4, 8, 13, 17],
      roster: LATE_ROSTER,
      seed: 7601,
      rareThreatCopies: 2,
    }),
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 5, 8, 10, 13, 15, 17, 19],
      swarmWaves: [4, 6, 9, 11, 14, 16, 18],
      roster: POST_TEN_SWARM_ROSTER,
      seed: 8401,
      rareThreatCopies: 2,
      spawnPatterns: {
        ...patternedWaves(20, ['north-south']),
        4: 'west',
        6: 'east',
        9: 'north',
        11: 'south',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 6, 8, 11, 13, 16, 18, 19],
      swarmWaves: [5, 9, 14, 17],
      roster: POST_TEN_ROSTER,
      seed: 9201,
      rareThreatCopies: 2,
      spawnPatterns: patternedWaves(20, ['north', 'east', 'south', 'west']),
      spawnDelayScales: { 5: 0.36, 9: 0.34, 14: 0.32, 17: 0.28 },
      labels: { 6: 'OSTFLANKE', 12: 'SÜDFLANKE', 18: 'WESTFLANKE' },
    }),
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 5, 7, 10, 12, 15, 17, 19],
      swarmWaves: [4, 8, 13, 18],
      roster: POST_TEN_SIEGE_ROSTER,
      seed: 10001,
      rareThreatCopies: 2,
      spawnPatterns: {
        ...patternedWaves(20, ['west', 'east']),
        4: 'north',
        8: 'south',
        13: 'north',
        18: 'south',
      },
      spawnDelayScales: { 4: 0.32, 8: 0.3, 13: 0.28, 18: 0.24 },
      labels: {
        4: 'NORDFLUT',
        8: 'SÜDFLUT',
        13: 'DAMMBRUCH',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      seed: 10901,
      rareThreatCopies: 2,
      spawnPatterns: patternedWaves(20, ['north-south', 'east-west', 'clockwise']),
      spawnDelayScales: { 5: 0.34, 9: 0.32, 14: 0.3, 17: 0.24 },
      labels: {
        5: 'BLOCKADE',
        10: 'HINTERHALT',
        15: 'KREUZFEUER',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 6, 9, 12, 15, 17, 19],
      swarmWaves: [4, 7, 10, 13, 16, 18],
      roster: POST_TEN_SIEGE_ROSTER,
      seed: 11801,
      rareThreatCopies: 2,
      spawnPatterns: patternedWaves(20, ['north', 'east', 'south', 'west']),
  ...
  },
  {
    ...
    waves: [
      ...
      },
      {
        kind: 'mini',
        label: 'SCHWERE JÄGER',
        zombies: pack({ brute: 2, stalker: 2, armored: 5, screamer: 2, phantom: 1 }),
      ...
      },
      {
        kind: 'normal',
        label: 'EISERNER RING',
        zombies: pack({ armored: 9, shieldbearer: 2, big: 5, screamer: 2 }),
        spawnPattern: 'clockwise',
      ...
      },
      {
        ...
        zombies: pack({ warden: 3, mortar: 3, brute: 3, spitter: 4, phantom: 1 }),
        spawnPattern: 'north-south',
        spawnDelayScale: 1.25,
      },
      {
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 6, 9, 12, 15, 17, 19],
      swarmWaves: [5, 8, 11, 14, 18],
      roster: VEIL_ROSTER,
      seed: 15401,
      rareThreatCopies: 4,
      spawnPatterns: patternedWaves(20, ['clockwise', 'north-south', 'east-west']),
      spawnDelayScales: { 5: 0.3, 8: 0.28, 11: 0.26, 14: 0.24, 18: 0.22 },
      labels: {
        5: 'SCHATTENSCHWARM',
        8: 'KEIN SIGNAL',
        11: 'PHANTOMFLUT',
        14: 'BLINDER FLECK',
        18: 'DER SCHLEIER FÄLLT',
      },
    }),
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      seed: 16401,
      rareThreatCopies: 3,
      spawnPatterns: patternedWaves(20, ['west', 'east', 'north-south']),
      spawnDelayScales: { 5: 0.32, 9: 0.3, 14: 0.28, 17: 0.22 },
      labels: {
        5: 'WESTKERN BEDRÄNGT',
        9: 'OSTKERN BEDRÄNGT',
        14: 'DREIFACHER ANGRIFF',
        17: 'SIGNALABBRUCH',
      },
    }),
    ...
    waves: [
      ...
      },
      {
        ...
        zombies: [
          ...
          'slag',
          'render',
          ...pack({ spitter: 7, screamer: 5, armored: 6, jammer: 2, blink: 3, evasive: 1 }),
        ],
        spawnPattern: 'east-west',
      ...
      },
      {
        ...
        zombies: [
          ...
          'omega',
          'bastion',
          ...pack({ crawler: 15, shieldbearer: 5, phantom: 3, phaseguard: 2 }),
        ],
        spawnPattern: 'clockwise',
      ...
      },
      {
        ...
        zombies: [
          ...
          'nightlord',
          'signalbreaker',
          ...pack({ warden: 2, mortar: 2, brute: 2, stalker: 2, jammer: 5, shieldbearer: 1 }),
        ],
        spawnPattern: 'clockwise',
      ...
      },
      {
        ...
        zombies: [
          ...
          'nightlord',
          'signalbreaker',
          ...pack({ brute: 2, warden: 2, stalker: 2, mortar: 2, phaseguard: 4, armored: 2 }),
        ],
        spawnPattern: 'clockwise',
