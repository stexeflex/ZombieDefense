...
export const MAPS: GameMap[] = [
  ...
  },
  {
    ...
    description:
      'Die alte Endlinie mit fünfundzwanzig Wellen. OMEGA bringt fast jede Fähigkeit der bisherigen Bosse mit — heilen kann es sich als einziges nicht.',
    difficulty: 7.6,
    moneyScale: 4.2,
    reward: 11250,
    boss: 'omega',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 6, 9, 12, 15, 18, 21, 24],
      swarmWaves: [4, 7, 10, 13, 16, 19, 22],
      roster: POST_TEN_SWARM_ROSTER,
      seed: 8401,
      rareThreatCopies: 2,
      spawnPatterns: {
        ...patternedWaves(25, ['north-south']),
        4: 'west',
        7: 'east',
        10: 'north',
        13: 'south',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      seed: 9201,
      rareThreatCopies: 2,
      spawnPatterns: patternedWaves(25, ['north', 'east', 'south', 'west']),
      spawnDelayScales: { 5: 0.36, 11: 0.34, 17: 0.32, 23: 0.28 },
      labels: { 7: 'OSTFLANKE', 14: 'SÜDFLANKE', 21: 'WESTFLANKE' },
    }),
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 6, 9, 12, 15, 18, 21, 24],
      swarmWaves: [5, 10, 16, 22],
      roster: POST_TEN_SIEGE_ROSTER,
      seed: 10001,
      rareThreatCopies: 2,
      spawnPatterns: {
        ...patternedWaves(25, ['west', 'east']),
        5: 'north',
        10: 'south',
        16: 'north',
        22: 'south',
      },
      spawnDelayScales: { 5: 0.32, 10: 0.3, 16: 0.28, 22: 0.24 },
      labels: {
        5: 'NORDFLUT',
        10: 'SÜDFLUT',
        16: 'DAMMBRUCH',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      seed: 10901,
      rareThreatCopies: 2,
      spawnPatterns: patternedWaves(25, ['north-south', 'east-west', 'clockwise']),
      spawnDelayScales: { 5: 0.34, 11: 0.32, 17: 0.3, 23: 0.24 },
      labels: {
        6: 'BLOCKADE',
        12: 'HINTERHALT',
        18: 'KREUZFEUER',
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      miniWaves: [3, 6, 9, 12, 15, 18, 21, 24],
      swarmWaves: [5, 10, 16, 20, 23],
      roster: VEIL_ROSTER,
      seed: 15401,
      rareThreatCopies: 4,
      spawnPatterns: patternedWaves(25, ['clockwise', 'north-south', 'east-west']),
      spawnDelayScales: { 5: 0.3, 10: 0.28, 16: 0.26, 20: 0.24, 23: 0.22 },
      labels: {
        5: 'SCHATTENSCHWARM',
        10: 'KEIN SIGNAL',
        16: 'PHANTOMFLUT',
        20: 'BLINDER FLECK',
        23: 'DER SCHLEIER FÄLLT',
      },
    }),
  ...
  },
  {
    ...
    waves: buildWaves({
      ...
      seed: 16401,
      rareThreatCopies: 3,
      spawnPatterns: patternedWaves(25, ['west', 'east', 'north-south']),
      spawnDelayScales: { 5: 0.32, 11: 0.3, 17: 0.28, 23: 0.22 },
      labels: {
        5: 'WESTKERN BEDRÄNGT',
        11: 'OSTKERN BEDRÄNGT',
