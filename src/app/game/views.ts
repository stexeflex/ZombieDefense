...
> = {
  ...
  stormorb: { texture: 'fx-glow', tint: 0x62d9ff, scaleX: 2.4, scaleY: 2.4 },
  ...
  turret_acid: { texture: 'fx-energy', tint: 0x42e9ff, scaleX: 1.05, scaleY: 0.9 },
  ...
  turret_longshot: { texture: 'fx-spark', tint: 0xffe0a3, scaleX: 2.2, scaleY: 0.48 },
  turret_plasma: { texture: 'fx-energy', tint: 0x7eeaff, scaleX: 4.6, scaleY: 0.68 },
  turret_ring: { texture: 'fx-glow', tint: 0xffd35c, scaleX: 1.65, scaleY: 0.65 },
  turret_ion_bastion: { texture: 'fx-energy', tint: 0x8fa8ff, scaleX: 5.4, scaleY: 0.78 },
  turret_gravity_well: { texture: 'fx-energy', tint: 0xa67cff, scaleX: 2.5, scaleY: 2.5 },
  turret_executioner: { texture: 'fx-glow', tint: 0xff526e, scaleX: 6.2, scaleY: 0.9 },
  turret_focus: { texture: 'fx-spark', tint: 0x9fffea, scaleX: 5.4, scaleY: 0.68 },
...
export const HAZARD_STYLE: Record<HazardKind, { tint: number; alpha: number }> = {
  ...
  nullField: { tint: 0x8c62ff, alpha: 0.3 },
  nullCore: { tint: 0x7dfff2, alpha: 0.72 },
};
